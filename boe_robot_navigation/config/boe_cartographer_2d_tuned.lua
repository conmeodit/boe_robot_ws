...
-- Giữ nguyên giới hạn đo thực tế của LiDAR BOE.
...
-- Giữ đủ node cho tốc độ 0.30 m/s nhưng không tạo quá nhiều constraint.
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.5
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.10
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.5)

-- Nhà có nhiều tường giống nhau nên phải loại các kết quả ghép mơ hồ.
